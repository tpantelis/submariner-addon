...
require (
	...
	github.com/submariner-io/cloud-prepare v0.19.0-m0
	github.com/submariner-io/submariner v0.19.0-m0
	github.com/submariner-io/submariner-operator v0.19.0-m0
...
// The submariner projects pull in a newer version of these dependencies that are
// incompatible with k8s.io/component-base so pin them to their prior versions.
