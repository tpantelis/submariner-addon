...
require (
	...
	github.com/submariner-io/cloud-prepare v0.19.0-rc3
	github.com/submariner-io/submariner v0.19.0-rc3
	github.com/submariner-io/submariner-operator v0.19.0-rc3
